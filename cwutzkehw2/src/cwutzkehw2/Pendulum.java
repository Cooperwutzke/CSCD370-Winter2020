...
public class Pendulum extends Region
{
     ...
     public void draw()
    {
        ...
        context.drawImage(new Image("images/background.jpeg"), 0, 0, WIDTH, HEIGHT);
        context.restore();
        ...
        context.drawImage(new Image("images/schimpf.jpeg"), -1, -1, 2, 3);
    ...
    protected void layoutChildren()
    {
        ...
        double calcHeight = width / ASPECT_RATIO;
        double calcWidth = height * ASPECT_RATIO;
        ...
        this.layoutInArea(mCanvas, 0, 0, width, height, this.getBaselineOffset(), Insets.EMPTY, HPos.CENTER, VPos.TOP);
